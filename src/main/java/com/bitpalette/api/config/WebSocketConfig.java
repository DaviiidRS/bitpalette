package com.bitpalette.api.config;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("/ws-bitpalette").setAllowedOriginPatterns("*").withSockJS();
    }

    // --- AÑADE ESTE MÉTODO PARA QUITAR EL ERROR DE TAMAÑO ---
    @Override
